...
base_path_org = 'Datasets/CEDAR/full_org/original_%d_%d.png'
base_path_forg = 'Datasets/CEDAR/full_forg/forgeries_%d_%d.png'
...
for _ in range(n_samples_of_each_class):
    ...
    # data.append(base_path_org)
    # data.append(base_path_forg)
